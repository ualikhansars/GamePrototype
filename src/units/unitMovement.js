...
import { ctxSave, ctxRestore, ctxTranslate, ctxRotate, ctxClearRect, ctxDrawImage, ctxTransform, ctxFillRect, // test
ctxFillStyle, // test
ctxBeginPath, ctxStrokeStyle, ctxMoveTo, ctxLineTo, ctxStroke } from '../utils/ctx';
...
// moveTo position
export const makeMovement = (unit, img, currentMoveToX, currentMoveToY, speedX, speedY, i) => {
...
//# sourceMappingURL=unitMovement.js.map